...
class SuccessOrderObserver implements ObserverInterface
{
    /**
     *
     * @var LoggerInterface
    ...
    public function execute(Observer $observer)
    {
        ...
        $this->logger->info("SuccessOrderObserver");
        $this->logger->info('send_order_success_page_observer', ['order'=>$orderData]);
    }
}
